            ...
            <div class="tab-content">
                ...
                <div id="home4" class="tab-pane active">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <h6>Materias</h6>
                            <select class="selectpicker" multiple data-style="btn-white" title='Selecciona una opción' id="Emateria" name="Emateria[]">
                                <?php echo getCatOpcionesMultiples("CatMateria", "Emateria[]", $Materias) ?>
                            </select>
                        </div>
                        <div class="col-md-12">
                            <h6>Observaciones</h6>
                ...
                <div id="messages4" class="tab-pane">
                    <?php echo form_open_multipart('docente/documentos/' . $this->uri->segment(3)); ?>
                    <div class="row">
