                    ...
                    <div class="panel panel-default text-center">
                        ...
                        <div class="panel-body">
                            ...
                            <div id="forgot-password-form" style="display: none">
                                <?php echo form_open('welcome/restablecer_contrasena'); ?>
                                <div class="panel panel-default text-center">
                                    <div class="panel-body">
                                        <p>Por favor ingrese el correo con el cual se registro en el sistema. Si no cuenta
                                            con el favor de comunicarse con un administrador. Gracias!</p>
                                        <input class="form-control" name="correo_restore" type="text" placeholder="Correo">
        ...
        <script>
            $(document).ready(function () {
                $("#forgot-password").click(function () {
                    $("#forgot-password-form").show(500);
                    $("#set-login-form").hide(500);
                });
            });
        </script>
    </body>
