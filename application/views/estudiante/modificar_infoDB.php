<div id="content">
    <div class="container-fluid">
        ...
        <div class="tabbable tabs-vertical tabs-left">
            ...
            <?php echo form_open('estudiante/modificar/'.$this->uri->segment(3)) ?>
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <h6>Discapacidad</h6>
                            <input type="text" class="form-control" name="Edisca" id="Edisca" value="<?php echo $gral['Enfermedad']; ?>">
                        </div>
                        <div class="col-md-4">
                            <h6>Correo</h6>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="Eescprod" id="Eescprod" value="<?php echo $gral['EscProcedencia']; ?>">
                        </div>
                        <div class="col-md-4">
                            <h6>Promedio</h6>
                            <input data-toggle="touch-spin" data-min="0" data-max="10" 
                                   data-step="0.1" data-decimals="2" type="text" 
                                   class="form-control" name="Epromedio" id="Epromedio" value="<?php echo $gral['Promedio']; ?>" >
                        </div>
                        <div class="col-md-4">
                            <h6>Matricula</h6>
                            <input type="text" class="form-control" name="Ematricula" id="Ematricula" 
                                   value="<?php echo $gral['Matricula']; ?>" readonly="">
                        </div>
                        <div class="col-md-4">
                            <h6>Turno</h6>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control" name="Egrupo" id="Egrupo">
                                <option value="0">Selecciona una opción</option>
                                <?php echo getCatOpciones("CatGrado","Egrupo",$gral['IDGrupo']) ?>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <h6>Descuento (%)</h6>
                            <input id="touch-spin-1" data-toggle="touch-spin" data-min="0" data-max="100" 
                                   ...
                                   name="Edescuento" value="<?php echo $gral['DescntoColegiatura']; ?>" class="form-control" style="display: block;">
                        </div>
                        <div class="col-md-12">
                            <h6>Observaciones</h6>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <h6>Nombre</h6>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="Pnombre" value="<?php echo $gralPadFam[0]['Nombre']; ?>" id="Pnombre" placeholder="">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <h6>Apellido Paterno</h6>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="Papaterno" value="<?php echo $gralPadFam[0]['APaterno']; ?>" id="Papaterno" placeholder="">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <h6>Apellido Materno</h6>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="Pamaterno" value="<?php echo $gralPadFam[0]['AMaterno']; ?>" id="Pamaterno" placeholder="">
                                </div>
                            </div>
                        </div>
                        <div class="row">    
                            <div class="col-md-4">
                                <h6>Fecha Nacimiento</h6>
                                <input id="datepickerFecP" type="text" class="form-control datepicker" name="Pfecnac" value="<?php echo $gralPadFam[0]['FecNac']; ?>">
                            </div>
                            <div class="col-md-4">
                                <h6>CURP</h6>
                                <input type="text" class="form-control" name="Pcurp" id="Pcurp" maxlength="18"
                                       value="<?php echo $gralPadFam[0]['CURP']; ?>">
                            </div>
                            <div class="col-md-4">
                                <h6>Discapacidad</h6>
                                <input type="text" class="form-control" name="Pdisca" id="Pdisca" value="<?php echo $gralPadFam[0]['Enfermedad']; ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <h6>Correo</h6>
                                <input type="text" class="form-control" name="Pcorreo" id="Pcorreo" value="<?php echo $gralPadFam[0]['Correo']; ?>">
                            </div>
                            <div class="col-md-4">
                                <h6>Sexo</h6>
                                <select class="form-control" name="Psexo" id="Psexo">
                                    <option value="M" <?php echo set_select('Psexo', 'M',$gralPadFam[0]['Sexo']=="M" ? TRUE : FALSE); ?>>Maculino</option>
                                    <option value="F" <?php echo set_select('Psexo', 'F',$gralPadFam[0]['Sexo']=="F" ? TRUE : FALSE); ?>>Femenino</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <h6>&nbsp;</h6>
                                <div class="checkbox">
                                    <input name="Ptrabaja" id="Ptrabaja" type="checkbox" value="1" <?php echo $gralPadFam[0]['Trabaja'] == 1 ? "checked" : ""; ?> >
                        ...
                        <div class="row">    
                            <div class="col-md-4">
                                <h6>Profesión</h6>
                                <input type="text" class="form-control" name="Pprofesion" id="Pprofesion" value="<?php echo $gralPadFam[0]['Profesion']; ?>">
                            </div>
                            <div class="col-md-4">
                                <h6>Ingreso Mensual</h6>
                                <input type="number" class="form-control" name="Pingreso" id="Pingreso" value="<?php echo $gralPadFam[0]['IngMensual']; ?>" >
                            </div>
                            <div class="col-md-4">
                                <h6>&nbsp;</h6>
                                <div class="checkbox">
                                    <input name="Ptutor" id="Ptutor" type="checkbox" value="1"  <?php echo $gralPadFam[0]['EsTutor'] == 1 ? "checked" : ""; ?>>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="Poficina" value="<?php echo $dire['PTelefono']; ?>" id="Poficina" maxlength="10">
                            </div>
                            <div class="col-md-4">
                                <h6>Num. Celular</h6>
                                <input type="text" class="form-control" name="Pcel"  value="<?php echo $dire['PCelular']; ?>" id="Pcel" maxlength="10">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <h6>Observaciones</h6>
                            <textarea rows="3" type="text" class="form-control" name="Pobserva" id="Pobserva"><?php echo $gralPadFam[0]['Observacion']; ?></textarea>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <h6>Nombre</h6>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="Mnombre" id="Mnombre"  value="<?php echo $gralPadFam[1]['Nombre']; ?>" placeholder="">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <h6>Apellido Paterno</h6>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="Mapaterno" id="Mapaterno"  value="<?php echo $gralPadFam[1]['APaterno']; ?>" placeholder="">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <h6>Apellido Materno</h6>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="Mamaterno" id="Mamaterno" value="<?php echo $gralPadFam[1]['AMaterno']; ?>" placeholder="">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <h6>Fecha Nacimiento</h6>
                                <input id="datepickerFecM" type="text" class="form-control datepicker" name="Mfecnac"  value="<?php echo $gralPadFam[1]['FecNac']; ?>">
                            </div>
                            <div class="col-md-4">
                                <h6>CURP</h6>
                                <input type="text" class="form-control" name="Mcurp" id="Mcurp" maxlength="18"
                                       value="<?php echo $gralPadFam[1]['CURP']; ?>">
                            </div>
                            <div class="col-md-4">
                                <h6>Discapacidad</h6>
                                <input type="text" class="form-control" name="Mdisca" id="Mdisca"  value="<?php echo $gralPadFam[1]['Enfermedad']; ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <h6>Correo</h6>
                                <input type="text" class="form-control" name="Mcorreo" id="Mcorreo" value="<?php echo $gralPadFam[1]['Correo']; ?>">
                            </div>
                            <div class="col-md-4">
                                <h6>Sexo</h6>
                                <select class="form-control" name="Msexo" id="Msexo">
                                    <option value="M" <?php echo set_select('Msexo', 'M',$gralPadFam[0]['Sexo']=="M" ? TRUE : FALSE); ?>>Maculino</option>
                                    <option value="F" <?php echo set_select('Msexo', 'F',$gralPadFam[0]['Sexo']=="F" ? TRUE : FALSE); ?>>Femenino</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <h6>&nbsp;</h6>
                                <div class="checkbox">
                                    <input type="checkbox" name="Mtrabaja" id="Mtrabaja" value="1"  <?php echo $gralPadFam[1]['Trabaja'] == 1 ? "checked" : ""; ?>>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <h6>Profesión</h6>
                                <input type="text" class="form-control" name="Mprofesion" id="Mprofesion" value="<?php echo $gralPadFam[1]['Profesion']; ?>">
                            </div>
                            <div class="col-md-4">
                                <h6>Ingreso Mensual</h6>
                                <input type="number" class="form-control" name="Mingreso" id="Mingreso" value="<?php echo $gralPadFam[1]['IngMensual']; ?>" >
                            </div>
                            <div class="col-md-4">
                                <h6>&nbsp;</h6>
                                <div class="checkbox">
                                    <input name="Mtutor" id="Mtutor" type="checkbox" value="1"  <?php echo $gralPadFam[1]['EsTutor'] == 1 ? "checked" : ""; ?>>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <h6>Telefono casa/oficina</h6>
                                <input type="text" class="form-control" name="Moficina" id="Moficina" maxlength="10" value="<?php echo $dire['MTelefono']; ?>">
                            </div>
                            <div class="col-md-4">
                                <h6>Num. Celular</h6>
                                <input type="text" class="form-control" name="Mcel" id="Mcel" maxlength="10" value="<?php echo $dire['MCelular']; ?>">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <h6>Observaciones</h6>
                            <textarea rows="3" type="text" class="form-control" name="Mobserva" id="Mobserva"><?php echo $gralPadFam[1]['Observacion']; ?></textarea>
                        </div>
                        <div class="col-md-12">
                            <br>
