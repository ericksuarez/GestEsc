    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                ...
                <label class="checkbox" style="display: none">
                    <input type="checkbox" value="#events-modal" id="events-in-modal" checked="true"> Abrir en la misma pagina.
                </label>	
            </div><hr>
            <div class="row">
                <div id="calendar"></div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true" id="cerrar-load">&times;</button>
        ...
        <script type="text/javascript">
            (function ($) {
                ...
                var options = {
                    events_source: '<?php echo site_url('events/getAll') ?>',
                    view: 'month',
                    language: 'es-ES',
