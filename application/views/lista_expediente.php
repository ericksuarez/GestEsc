    ...
    <div class="container-fluid">
        ...
        <div class="panel-body">
            <div class="pull-right">
                <a class="btn btn-primary" data-url="/demo/bootstrap_theme/export">
                ...
                <a class="btn btn-primary" data-url="/demo/bootstrap_theme/print">
            ...
            <div class="panel-body">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="" id="" placeholder="Nombre(s) Apellido paterno Apellido materno">
                    </div>
                </div>
                <div class="col-md-3">
                    <h5>Matricula</h5>
                    <div class="form-group">
                        <input type="email" class="form-control" id="" placeholder="XXXX0000">
                    </div>
                </div>
                <div class="col-md-3">
                    <h5>Turno</h5>
                    <select class="form-control" name="" id="">
                        <option>Seleccióna una opción</option>
                    </select>
                </div>
                <div class="col-md-3">
                    ...
                    <div class="checkbox">
                        ...
                        <label for="checkbox1">Adeudos</label>
                    </div>
                </div>
                <div class="col-md-3">
                    <h5>&nbsp;</h5>
