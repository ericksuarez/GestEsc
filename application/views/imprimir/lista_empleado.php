<html>
    ...
    <body lang=EN-US>
        ...
        <div class=WordSection1>
            ...
            <p class=MsoNormal align=center style='text-align:center'><b><i><span
                            style='font-size:10.0pt;line-height:115%'>Lista de Empleados</span></i></b></p>
              ...
              <table class=MsoTableLightShading border=1 cellspacing=0 cellpadding=0
                ...
                <tr>
                    ...
                    <td width=91 valign=top style='width:.95in;border-top:solid black 1.0pt;
                        ...
                        padding:0in 5.4pt 0in 5.4pt'>
                        <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
                           text-align:center;line-height:normal'><b><span style='color:black'>PUESTO</span></b></p>
                    </td>
                    <td width=91 valign=top style='width:.95in;border-top:solid black 1.0pt;
                        border-left:none;border-bottom:solid black 1.0pt;border-right:none;
                        padding:0in 5.4pt 0in 5.4pt'>
                ...
                <?php foreach ($empleado as $key => $info) { ?>
                    <tr>
