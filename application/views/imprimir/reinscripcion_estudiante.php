                ...
                <tr>
                    <td width=91 valign=top style='width:.95in;border-top:solid black 1.0pt;
                        ...
                        <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
                           text-align:center;line-height:normal'><b><span style='color:black'>MATRICULA</span></b></p>
                    </td>
                    <td width=91 valign=top style='width:.95in;border-top:solid black 1.0pt;
                        border-left:none;border-bottom:solid black 1.0pt;border-right:none;
                        padding:0in 5.4pt 0in 5.4pt'>
                    ...
                    <td width=91 valign=top style='width:.95in;border-top:solid black 1.0pt;
                        ...
                        padding:0in 5.4pt 0in 5.4pt'>
                        <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
                           text-align:center;line-height:normal'><b><span style='color:black'>REINSCRIPCION</span></b></p>
                    </td>
                </tr>
                <?php foreach ($estudiante as $key => $info) { ?>
                    <tr>
                        <td width=91 valign=top style='width:.95in;border:none;border-bottom:solid black 1.0pt;
                            ...
                            <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
                               text-align:center;line-height:normal'><i><span style='color:black'>
                                        <?php echo $info['Matricula']; ?></span></i></p>
                        </td>
                        <td width=91 valign=top style='width:.95in;border:none;border-bottom:solid black 1.0pt;
                            padding:0in 5.4pt 0in 5.4pt'>
                            <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
                        ...
                        <td width=91 valign=top style='width:.95in;border:none;border-bottom:solid black 1.0pt;
                            ...
                            <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
                               text-align:center;line-height:normal'><i><span style='color:black'>
                               <?php echo $info['Grado'] . '-' . $info['Grupo']; ?>
                                    </span></i></p>
                        </td>
                        <td width=91 valign=top style='width:.95in;border:none;border-bottom:solid black 1.0pt;
                            padding:0in 5.4pt 0in 5.4pt'>
                        ...
                        <td width=91 valign=top style='width:.95in;border:none;border-bottom:solid black 1.0pt;
                            ...
                            <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
                               text-align:center;line-height:normal'><i><span style='color:black'>
                                        <?php echo FecFormatoView($info['FecInscripcion']); ?></span></i></p>
                        </td>
                    </tr>
                <?php } ?>
            </table>
